...
| Coverage | ~86% |
| Convergence | 1.0.0: U→V streak 2 → released. 1.0.1: W→X clean → released. 1.0.2: HH→II streak 2 → released. 1.0.3: JJ clean → released. 1.0.4: KK (1 MEDIUM Python-asymmetry + 1 LOW C# ctor, both fixed) → **LL clean (streak 1)** → MM (second confirmation in progress) |
